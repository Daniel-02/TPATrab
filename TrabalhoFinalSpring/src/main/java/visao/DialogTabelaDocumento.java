...
public class DialogTabelaDocumento extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		// Para cada botão exibido é executado o método
		// getTableCellRendererComponent()
		// que retorna o botão que deve ser renderizado.
		// E sempre que um botão é clicado é executado o método
		// getTableCellEditorComponent()
		// que retorna o botão que foi clicado para que o listener deste botão
		// possa ser executado.
		new ButtonColumn(table, 4, this, dialogDocumento); // Parametros na
															// ordem ==> Tabela,
															// número da coluna
															// onde está o
															// botão, this da
