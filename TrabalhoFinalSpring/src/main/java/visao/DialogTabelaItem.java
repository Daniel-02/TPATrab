...
public class DialogTabelaItem extends JDialog implements ActionListener
{
	...
	public DialogTabelaItem(DialogItem dialogItem)
	{
		super(dialogItem);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		new ButtonColumn(table, 4, this, dialogItem); //Parametros na ordem ==> Tabela, número da coluna onde está o botão, this da janela de busca, janela anterior a janela de busca.
