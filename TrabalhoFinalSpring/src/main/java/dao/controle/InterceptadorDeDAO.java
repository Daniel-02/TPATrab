...
public class InterceptadorDeDAO implements MethodInterceptor {
	...
	public Object intercept(Object objeto, Method metodo, Object[] args, MethodProxy metodoDoProxy) throws Throwable {
		System.out.println("Entrou no interceptador. método " + metodo.getName());
		// Entrou no interceptador. método recuperaPrimeiroProduto
		System.out.println("Entrou no interceptador. this = " + this.getClass().getName());
		// Entrou no interceptador. this = dao.controle.InterceptadorDeDAO
		System.out.println("Entrou no interceptador. objeto = " + objeto.getClass().getName());
		// Entrou no interceptador. objeto =
