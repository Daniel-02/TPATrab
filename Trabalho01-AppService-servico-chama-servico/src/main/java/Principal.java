	...
	public static void main(String[] args) {
		...
		while (continua) {
			...
			case 1: {
				...
				System.out.println('\n' + "Conta número " + numero + " incluído com sucesso!");
			...
			case 2: {
				...
				System.out.println('\n' + "Número = " + umaConta.getId() + "    Saldo = " + umaConta.getSaldo());
			...
			case 4: {
				...
				for (Conta conta : contas) {
					System.out.println('\n' + "Id = " + conta.getId() + "  Saldo = " + conta.getSaldo()
			...
			case 7: {
				...
				System.out.println('\n' + "Número da conta debitada = " + contaDebitada.getId() + "    Saldo = "
						+ contaDebitada.getSaldo());

				System.out.println('\n' + "Número da conta creditada = " + contaCreditada.getId() + "    Saldo = "
						+ contaCreditada.getSaldo());
