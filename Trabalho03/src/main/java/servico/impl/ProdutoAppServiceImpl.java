...
public class ProdutoAppServiceImpl implements ProdutoAppService {
	...
	@Perfil(nome = "admin")
	@RollbackFor(nomes = { ProdutoNaoEncontradoException.class, ClienteNaoEncontradoException.class })
	...
	public Produto recuperaUmProduto(long numero) throws ProdutoNaoEncontradoException {
		try {
			// System.out.println("Vai chamar o método recuperaUmProduto() de
			// ProdutoDAOImpl.");
	...
	public List<Produto> recuperaProdutos() {
		// System.out.println("Vai chamar o método recuperaProdutos() de
		// ProdutoDAOImpl.");
