...
//			em = JPAUtil.getEntityManager();
			Field[] fields = objeto.getClass().getSuperclass().getSuperclass().getDeclaredFields();
			...
			} else if (metodo.isAnnotationPresent(RecuperaUltimoOuPrimeiro.class)) { // O método buscaUltimoOuPrimeiro() retorna um Objeto (Entidade)
