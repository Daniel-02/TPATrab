		...
		while (continua) {
			...
			case 2: {
				...
				System.out.println('\n' + "Número = " + umProduto.getId() + "    Nome = " + umProduto.getNome()
						+ "    Lance Mínimo = " + umProduto.getLanceMinimo() + "    Versão = " + umProduto.getVersao());
				...
				case 1:
					...
					try {
						...
						System.out.println('\n' + "A operação não foi " + "efetuada: os dados que você "
								+ "tentou salvar foram modificados " + "por outro usuário.");
					}
			...
			case 4: {
				...
				for (Produto produto : produtos) {
					System.out.println('\n' + "Id = " + produto.getId() + "  Nome = " + produto.getNome()
							+ "  Lance mínimo = " + produto.getLanceMinimo() + "  Data Cadastro = "
							+ produto.getDataCadastroMasc() + "  Versão = " + produto.getVersao());
				}
